...
internal static class Ks4HeadlineMeasures
{
    public static class Attainment8
    {
        ...
        public static Measure ForSchoolComparison(SchoolData<Ks4PerformanceData> currentSchool, SchoolData<Ks4PerformanceData> similarSchool, IEnumerable<SchoolData<Ks4PerformanceData>> similarSchools, CaseInsensitiveDictionary<string> filters)
        {
            var (availableFilters, fieldSelector) = ResolveFilters(filters);
    ...
    {
        public static Measure ForSchool(SchoolData<Ks4DestinationsData> currentSchool, IEnumerable<SchoolData<Ks4DestinationsData>> similarSchools, CaseInsensitiveDictionary<string> filters)
        {
            var (availableFilters, fieldSelector) = ResolveFilters(filters);
        ...
        public static Measure ForSchoolComparison(SchoolData<Ks4DestinationsData> currentSchool, SchoolData<Ks4DestinationsData> similarSchool, IEnumerable<SchoolData<Ks4DestinationsData>> similarSchools, CaseInsensitiveDictionary<string> filters)
        {
            var (availableFilters, fieldSelector) = ResolveFilters(filters);
