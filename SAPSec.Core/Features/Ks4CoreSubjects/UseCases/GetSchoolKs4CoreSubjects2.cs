...
public class GetSchoolKs4CoreSubjects2(
    IKs4PerformanceRepository repository,
    ISchoolDetailsService schoolDetailsService,
    IEstablishmentRepository establishmentRepository,
    ISimilarSchoolsSecondaryRepository similarSchoolsRepository)
{
    public async Task<GetSchoolKs4CoreSubjectsResponse2> Execute(GetSchoolKs4CoreSubjectsRequest request)
    {
...
public record GetSchoolKs4CoreSubjectsRequest2(string Urn);
    ...
    SchoolKs4ComparisonYearByYear YearByYear)
{
    public static SchoolKs4CoreSubjectSelection From(
        GetSchoolKs4CoreSubjectsResponse2 response,
...
public record GetSchoolKs4CoreSubjectsResponse2(
    SchoolDetails SchoolDetails,
