    ...
    : IUseCase<GetSchoolComparisonKs4HeadlineMeasuresRequest, GetSchoolComparisonKs4HeadlineMeasuresResponse>
{
    public async Task<GetSchoolComparisonKs4HeadlineMeasuresResponse> Execute(GetSchoolComparisonKs4HeadlineMeasuresRequest request)
    {
        ...
        return new(
            ...
            Ks4HeadlineMeasures.Attainment8.ForSchoolComparison(currentSchoolData, similarSchoolData, similarSchoolsData, filterBy),
            Ks4HeadlineMeasures.EnglishAndMaths.ForSchoolComparison(currentSchoolData, similarSchoolData, similarSchoolsData, filterBy),
            Ks4HeadlineMeasures.Destinations.ForSchoolComparison(currentSchoolData, similarSchoolData, similarSchoolsData, filterBy));
    }
}
