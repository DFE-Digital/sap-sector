...
internal static class Ks4HeadlineMeasures
{
    ...
    {
        public static Measure ForSecondarySchool(SecondarySchoolData<Ks4DestinationsData> currentSchool, IEnumerable<SecondarySchoolData<Ks4DestinationsData>> similarSchools, IDictionary<string, string> filters)
        {
        ...
        public static Measure ForSecondarySchoolComparison(SecondarySchoolData<Ks4DestinationsData> currentSchool, SecondarySchoolData<Ks4DestinationsData> similarSchool, IEnumerable<SecondarySchoolData<Ks4DestinationsData>> similarSchools, IDictionary<string, string> filters)
        {
            var destinationType = filters.ContainsKey("destinations:destination") ? filters["destinations:destination"] : "all";
