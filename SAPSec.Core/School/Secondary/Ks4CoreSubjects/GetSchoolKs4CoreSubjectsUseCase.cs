    ...
    : IUseCase<GetSchoolKs4CoreSubjectsRequest, GetSchoolKs4CoreSubjectsResponse>
{
    public async Task<GetSchoolKs4CoreSubjectsResponse> Execute(GetSchoolKs4CoreSubjectsRequest request)
    {
        ...
        return new(
            ...
            [
                Ks4CoreSubjects.EnglishLanguage.ForSchool(schoolData, similarSchools, filterBy),
                Ks4CoreSubjects.EnglishLiterature.ForSchool(schoolData, similarSchools, filterBy),
                Ks4CoreSubjects.Biology.ForSchool(schoolData, similarSchools, filterBy),
                Ks4CoreSubjects.Chemistry.ForSchool(schoolData, similarSchools, filterBy),
                Ks4CoreSubjects.Physics.ForSchool(schoolData, similarSchools, filterBy),
                Ks4CoreSubjects.Mathematics.ForSchool(schoolData, similarSchools, filterBy),
                Ks4CoreSubjects.CombinedScience.ForSchool(schoolData, similarSchools, filterBy),
            ]);
    }
}
