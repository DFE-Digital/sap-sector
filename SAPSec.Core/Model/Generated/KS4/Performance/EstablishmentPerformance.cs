...
public class EstablishmentPerformance
{
    ...
    public string Bio49_Sum_Est_Current_Pct { get; set; } = string.Empty;
    public string Bio49_Sum_Est_Previous_Num { get; set; } = string.Empty;
    public string Bio49_Sum_Est_Previous_Pct { get; set; } = string.Empty;
    public string Bio49_Sum_Est_Previous2_Num { get; set; } = string.Empty;
    public string Bio49_Sum_Est_Previous2_Pct { get; set; } = string.Empty;
    ...
    public string Bio59_Sum_Est_Current_Pct { get; set; } = string.Empty;
    public string Bio59_Sum_Est_Previous_Num { get; set; } = string.Empty;
    public string Bio59_Sum_Est_Previous_Pct { get; set; } = string.Empty;
    public string Bio59_Sum_Est_Previous2_Num { get; set; } = string.Empty;
    public string Bio59_Sum_Est_Previous2_Pct { get; set; } = string.Empty;
    ...
    public string Bio79_Sum_Est_Current_Pct { get; set; } = string.Empty;
    public string Bio79_Sum_Est_Previous_Num { get; set; } = string.Empty;
    public string Bio79_Sum_Est_Previous_Pct { get; set; } = string.Empty;
    public string Bio79_Sum_Est_Previous2_Num { get; set; } = string.Empty;
    public string Bio79_Sum_Est_Previous2_Pct { get; set; } = string.Empty;
    ...
    public string Chem49_Sum_Est_Current_Pct { get; set; } = string.Empty;
    public string Chem49_Sum_Est_Previous_Num { get; set; } = string.Empty;
    public string Chem49_Sum_Est_Previous_Pct { get; set; } = string.Empty;
    public string Chem49_Sum_Est_Previous2_Num { get; set; } = string.Empty;
    public string Chem49_Sum_Est_Previous2_Pct { get; set; } = string.Empty;
    ...
    public string Chem59_Sum_Est_Current_Pct { get; set; } = string.Empty;
    public string Chem59_Sum_Est_Previous_Num { get; set; } = string.Empty;
    public string Chem59_Sum_Est_Previous_Pct { get; set; } = string.Empty;
    public string Chem59_Sum_Est_Previous2_Num { get; set; } = string.Empty;
    public string Chem59_Sum_Est_Previous2_Pct { get; set; } = string.Empty;
    ...
    public string Chem79_Sum_Est_Current_Pct { get; set; } = string.Empty;
    public string Chem79_Sum_Est_Previous_Num { get; set; } = string.Empty;
    public string Chem79_Sum_Est_Previous_Pct { get; set; } = string.Empty;
    public string Chem79_Sum_Est_Previous2_Num { get; set; } = string.Empty;
    public string Chem79_Sum_Est_Previous2_Pct { get; set; } = string.Empty;
    ...
    public string CombSci49_Sum_Est_Current_Pct { get; set; } = string.Empty;
    public string CombSci49_Sum_Est_Previous_Num { get; set; } = string.Empty;
    public string CombSci49_Sum_Est_Previous_Pct { get; set; } = string.Empty;
    public string CombSci49_Sum_Est_Previous2_Num { get; set; } = string.Empty;
    public string CombSci49_Sum_Est_Previous2_Pct { get; set; } = string.Empty;
    ...
    public string CombSci59_Sum_Est_Current_Pct { get; set; } = string.Empty;
    public string CombSci59_Sum_Est_Previous_Num { get; set; } = string.Empty;
    public string CombSci59_Sum_Est_Previous_Pct { get; set; } = string.Empty;
    public string CombSci59_Sum_Est_Previous2_Num { get; set; } = string.Empty;
    public string CombSci59_Sum_Est_Previous2_Pct { get; set; } = string.Empty;
    ...
    public string CombSci79_Sum_Est_Current_Pct { get; set; } = string.Empty;
    public string CombSci79_Sum_Est_Previous_Num { get; set; } = string.Empty;
    public string CombSci79_Sum_Est_Previous_Pct { get; set; } = string.Empty;
    public string CombSci79_Sum_Est_Previous2_Num { get; set; } = string.Empty;
    public string CombSci79_Sum_Est_Previous2_Pct { get; set; } = string.Empty;
    ...
    public string EngLang49_Sum_Est_Current_Pct { get; set; } = string.Empty;
    public string EngLang49_Sum_Est_Previous_Num { get; set; } = string.Empty;
    public string EngLang49_Sum_Est_Previous_Pct { get; set; } = string.Empty;
    public string EngLang49_Sum_Est_Previous2_Num { get; set; } = string.Empty;
    public string EngLang49_Sum_Est_Previous2_Pct { get; set; } = string.Empty;
    ...
    public string EngLang59_Sum_Est_Current_Pct { get; set; } = string.Empty;
    public string EngLang59_Sum_Est_Previous_Num { get; set; } = string.Empty;
    public string EngLang59_Sum_Est_Previous_Pct { get; set; } = string.Empty;
    public string EngLang59_Sum_Est_Previous2_Num { get; set; } = string.Empty;
    public string EngLang59_Sum_Est_Previous2_Pct { get; set; } = string.Empty;
    ...
    public string EngLang79_Sum_Est_Current_Pct { get; set; } = string.Empty;
    public string EngLang79_Sum_Est_Previous_Num { get; set; } = string.Empty;
    public string EngLang79_Sum_Est_Previous_Pct { get; set; } = string.Empty;
    public string EngLang79_Sum_Est_Previous2_Num { get; set; } = string.Empty;
    public string EngLang79_Sum_Est_Previous2_Pct { get; set; } = string.Empty;
    ...
    public string EngLit49_Sum_Est_Current_Pct { get; set; } = string.Empty;
    public string EngLit49_Sum_Est_Previous_Num { get; set; } = string.Empty;
    public string EngLit49_Sum_Est_Previous_Pct { get; set; } = string.Empty;
    public string EngLit49_Sum_Est_Previous2_Num { get; set; } = string.Empty;
    public string EngLit49_Sum_Est_Previous2_Pct { get; set; } = string.Empty;
    ...
    public string EngLit59_Sum_Est_Current_Pct { get; set; } = string.Empty;
    public string EngLit59_Sum_Est_Previous_Num { get; set; } = string.Empty;
    public string EngLit59_Sum_Est_Previous_Pct { get; set; } = string.Empty;
    public string EngLit59_Sum_Est_Previous2_Num { get; set; } = string.Empty;
    public string EngLit59_Sum_Est_Previous2_Pct { get; set; } = string.Empty;
    ...
    public string EngLit79_Sum_Est_Current_Pct { get; set; } = string.Empty;
    public string EngLit79_Sum_Est_Previous_Num { get; set; } = string.Empty;
    public string EngLit79_Sum_Est_Previous_Pct { get; set; } = string.Empty;
    public string EngLit79_Sum_Est_Previous2_Num { get; set; } = string.Empty;
    public string EngLit79_Sum_Est_Previous2_Pct { get; set; } = string.Empty;
    ...
    public string Maths49_Sum_Est_Current_Pct { get; set; } = string.Empty;
    public string Maths49_Sum_Est_Previous_Num { get; set; } = string.Empty;
    public string Maths49_Sum_Est_Previous_Pct { get; set; } = string.Empty;
    public string Maths49_Sum_Est_Previous2_Num { get; set; } = string.Empty;
    public string Maths49_Sum_Est_Previous2_Pct { get; set; } = string.Empty;
    ...
    public string Maths59_Sum_Est_Current_Pct { get; set; } = string.Empty;
    public string Maths59_Sum_Est_Previous_Num { get; set; } = string.Empty;
    public string Maths59_Sum_Est_Previous_Pct { get; set; } = string.Empty;
    public string Maths59_Sum_Est_Previous2_Num { get; set; } = string.Empty;
    public string Maths59_Sum_Est_Previous2_Pct { get; set; } = string.Empty;
    ...
    public string Maths79_Sum_Est_Current_Pct { get; set; } = string.Empty;
    public string Maths79_Sum_Est_Previous_Num { get; set; } = string.Empty;
    public string Maths79_Sum_Est_Previous_Pct { get; set; } = string.Empty;
    public string Maths79_Sum_Est_Previous2_Num { get; set; } = string.Empty;
    public string Maths79_Sum_Est_Previous2_Pct { get; set; } = string.Empty;
    ...
    public string Physics49_Sum_Est_Current_Pct { get; set; } = string.Empty;
    public string Physics49_Sum_Est_Previous_Num { get; set; } = string.Empty;
    public string Physics49_Sum_Est_Previous_Pct { get; set; } = string.Empty;
    public string Physics49_Sum_Est_Previous2_Num { get; set; } = string.Empty;
    public string Physics49_Sum_Est_Previous2_Pct { get; set; } = string.Empty;
    ...
    public string Physics59_Sum_Est_Current_Pct { get; set; } = string.Empty;
    public string Physics59_Sum_Est_Previous_Num { get; set; } = string.Empty;
    public string Physics59_Sum_Est_Previous_Pct { get; set; } = string.Empty;
    public string Physics59_Sum_Est_Previous2_Num { get; set; } = string.Empty;
    public string Physics59_Sum_Est_Previous2_Pct { get; set; } = string.Empty;
    ...
    public string Physics79_Sum_Est_Current_Pct { get; set; } = string.Empty;
    public string Physics79_Sum_Est_Previous_Num { get; set; } = string.Empty;
    public string Physics79_Sum_Est_Previous_Pct { get; set; } = string.Empty;
    public string Physics79_Sum_Est_Previous2_Num { get; set; } = string.Empty;
    public string Physics79_Sum_Est_Previous2_Pct { get; set; } = string.Empty;
