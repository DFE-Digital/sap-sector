...
//public class PrimarySimilarSchoolsPageViewModelX : ISimilarSchoolsPageViewModel
//{
...
//    public IReadOnlyCollection<SimilarSchoolViewModel> SimilarSchools { get; init; } = [];
//    public IReadOnlyCollection<SimilarSchoolViewModel> MapSchools { get; init; } = [];
...
//    IReadOnlyCollection<SimilarSchoolViewModel> ISimilarSchoolsPageViewModel.SimilarSchools => SimilarSchools;
...
//                FullAddress = BuildFullAddress(row.Address.Street, row.Address.Town, row.Address.Postcode),
