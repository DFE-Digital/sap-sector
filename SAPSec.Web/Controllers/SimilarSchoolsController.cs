...
public class SimilarSchoolsController : Controller
{
        ...
        [FromQuery] int page = 1)
    {
        ...
        var allSchools = GetMockSimilarSchools(urn);
        ...
        {
            Urn = urn,
            EstablishmentName = "Oak Nest Secondary School", // TODO: Get from v_establishment
    ...
    private static List<SimilarSchoolViewModel> GetMockSimilarSchools(int urn)
    {
        return new List<SimilarSchoolViewModel>
        {
            // Rank 1-10: Based on real CSV patterns (URN 100050's similar schools)
            new()
            {
