...
/// </summary>
public class SimilarSchoolsPageViewModel : ISimilarSchoolsPageViewModel
{
    ...
    IReadOnlyCollection<ISimilarSchoolRowViewModel> ISimilarSchoolsPageViewModel.SimilarSchools => Schools;
...
public record SimilarSchoolsFilterGroupViewModel(
    string Heading,
    List<Core.Features.SimilarSchools.UseCases.SimilarSchoolsAvailableFilter> Filters);
