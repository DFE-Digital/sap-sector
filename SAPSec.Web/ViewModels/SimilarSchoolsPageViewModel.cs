...
///// </summary>
//public class SimilarSchoolsPageViewModelX : ISimilarSchoolsPageViewModel
//{
...
//    public string FilterFormUrl { get; set; } = string.Empty;
//    public string WhatIsASimilarSchoolUrl { get; set; } = string.Empty;
//    public List<SimilarSchoolViewModel> Schools { get; set; } = new();
//    public List<SimilarSchoolViewModel> MapSchools { get; set; } = new();
//    public IReadOnlyCollection<Core.Features.SimilarSchools.UseCases.SimilarSchoolsAvailableFilter> FilterOptions { get; set; } = [];
//    public IReadOnlyCollection<Core.Features.Sorting.SortOption> SortOptions { get; set; } = [];
...
//    string ISimilarSchoolsPageViewModel.Urn => Urn.ToString();
//    string ISimilarSchoolsPageViewModel.SchoolName => EstablishmentName;
//    string ISimilarSchoolsPageViewModel.PhaseLabel => "secondary";
//    string ISimilarSchoolsPageViewModel.NoResultsMessage => "There are no schools that match your search.";
//    string ISimilarSchoolsPageViewModel.ResultsBaseUrl => FilterFormUrl;
//    IReadOnlyCollection<SimilarSchoolViewModel> ISimilarSchoolsPageViewModel.SimilarSchools => Schools;
//    IReadOnlyCollection<SimilarSchoolViewModel> ISimilarSchoolsPageViewModel.MapSchools => MapSchools;
