...
public static class MockSimilarSchoolsData
{
    public static List<SimilarSchoolViewModel> GetSimilarSchools(int urn)
    {
        return new List<SimilarSchoolViewModel>
        {
            ...
            new()
            {
                Urn = urn, SimilarUrn = 100750, Dist = 0.3573, Rank = 1,
            ...
            new()
            {
                Urn = urn, SimilarUrn = 102153, Dist = 0.3646, Rank = 2,
            ...
            new()
            {
                Urn = urn, SimilarUrn = 137442, Dist = 0.3892, Rank = 3,
            ...
            new()
            {
                Urn = urn, SimilarUrn = 100741, Dist = 0.4231, Rank = 4,
            ...
            new()
            {
                Urn = urn, SimilarUrn = 100279, Dist = 0.4300, Rank = 5,
            ...
            new()
            {
                Urn = urn, SimilarUrn = 100280, Dist = 0.4412, Rank = 6,
            ...
            new()
            {
                Urn = urn, SimilarUrn = 100281, Dist = 0.4520, Rank = 7,
            ...
            new()
            {
                Urn = urn, SimilarUrn = 100282, Dist = 0.4635, Rank = 8,
            ...
            new()
            {
                Urn = urn, SimilarUrn = 100283, Dist = 0.4750, Rank = 9,
            ...
            new()
            {
                Urn = urn, SimilarUrn = 100284, Dist = 0.4880, Rank = 10,
