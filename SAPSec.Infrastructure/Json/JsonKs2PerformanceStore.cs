    ...
    IJsonFile<EnglandPerformance> englandPerformanceFile) : IKs2PerformanceStore
{
    ...
    public async Task<IReadOnlyCollection<Ks2PerformanceData>> GetByUrnsAsync(IEnumerable<string> urns)
    {
        ...
        var laIds = establishments.Values
            ...
            .Distinct(StringComparer.Ordinal)
            .ToArray();
        var localAuthorityPerformanceByLaId = (await laPerformanceFile.ReadAllAsync())
        ...
        var results = new List<Ks2PerformanceData>(requestedUrns.Length);
        ...
        foreach (var urn in requestedUrns)
        {
            ...
            results.Add(new Ks2PerformanceData(
                urn,
