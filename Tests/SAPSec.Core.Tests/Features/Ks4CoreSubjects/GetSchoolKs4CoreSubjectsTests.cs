...
//        var subject = result.Measures.First(s => s.Key == "english-language");
...
//        var result = await context.Sut.Execute(new GetSchoolKs4CoreSubjectsRequest("100001"));
//        var subject = result.Measures.First(s => s.Key == "combined-science");
...
//        var subject = result.Measures.First(s => s.Key == "biology");
...
//        var subject = result.Measures.First(s => s.Key == "chemistry");
...
//        var subject = result.Measures.First(s => s.Key == "physics");
...
//        var subject = result.Measures.First(s => s.Key == "maths");
