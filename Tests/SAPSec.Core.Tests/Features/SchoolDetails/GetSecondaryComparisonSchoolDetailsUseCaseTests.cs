...
public class GetSecondaryComparisonSchoolDetailsUseCaseTests
{
    ...
    private readonly GetSecondaryComparisonSchoolDetailsUseCase _sut;

    public GetSecondaryComparisonSchoolDetailsUseCaseTests()
    {
        _sut = new GetSecondaryComparisonSchoolDetailsUseCase(
            _establishmentRepo,
            _similarSchoolsRepo,
            new SchoolDetailsService(_establishmentRepo, new SchoolClosureEligibilityService(_establishmentRepo, Mock.Of<ILogger<SchoolClosureEligibilityService>>()), _loggerMock.Object));
    }
    ...
    {
        _establishmentRepo.SetupEstablishments(
            Build.Establishment("100001", "Current School", x => x.WithEastingNorthing(430000, 380000)),
            Build.Establishment("100002", "Comparator School"));
