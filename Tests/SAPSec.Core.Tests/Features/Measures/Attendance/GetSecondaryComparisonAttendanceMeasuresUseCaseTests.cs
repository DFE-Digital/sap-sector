...
public class GetSecondaryComparisonAttendanceMeasuresUseCaseTests
{
    ...
    private readonly GetSecondaryComparisonAttendanceMeasuresUseCase _sut;

    public GetSecondaryComparisonAttendanceMeasuresUseCaseTests()
    {
        _establishmentRepo = new();
        _similarSchoolsRepo = new();
        _absenceRepo = new(_establishmentRepo);
        _sut = new GetSecondaryComparisonAttendanceMeasuresUseCase(
            _establishmentRepo,
            _similarSchoolsRepo,
            _absenceRepo);
    }
