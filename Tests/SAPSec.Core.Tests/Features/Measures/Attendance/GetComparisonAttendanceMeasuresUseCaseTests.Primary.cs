...
public partial class GetComparisonAttendanceMeasuresUseCaseTests
{
    ...
    public async Task Primary_Absence_FilterBy_PupilCharacteristic_WhenMissing_DefaultsToAllPupils()
    {
        ...
        var withoutFilter = await _sut.Execute(Request(MeasurePhase.Primary, "100001", "100002"));
        var withExplicitAllPupils = await _sut.Execute(Request(MeasurePhase.Primary, "100001", "100002", new()
        {
