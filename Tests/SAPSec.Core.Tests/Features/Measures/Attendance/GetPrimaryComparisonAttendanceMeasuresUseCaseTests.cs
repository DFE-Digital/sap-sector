...
public class GetPrimaryComparisonAttendanceMeasuresUseCaseTests
{
    ...
    private readonly GetPrimaryComparisonAttendanceMeasuresUseCase _sut;

    public GetPrimaryComparisonAttendanceMeasuresUseCaseTests()
    {
        _establishmentRepo = new();
        _similarSchoolsRepo = new();
        _absenceRepo = new(_establishmentRepo);
        _sut = new GetPrimaryComparisonAttendanceMeasuresUseCase(
            _establishmentRepo,
            _similarSchoolsRepo,
            _absenceRepo);
    }
    ...
    public async Task Absence_ContainsYearByYearValuesForCurrentAndSimilarSchool()
    {
        ...
        series.Should().BeEquivalentTo([
            ...
            new MeasureSeries(MeasureSeriesType.ComparatorSchool, 6.10m, 6.20m, 6.30m),
    ...
    [InlineData(MeasureSeriesType.ComparatorSchool)]
    ...
    [Fact]
    public async Task Absence_FilterBy_IgnoresInvalidFilterKeys()
    {
        _establishmentRepo.SetupEstablishments(
            Build.Establishment("100001", "Test School 1", x => x.Primary()),
            Build.Establishment("100002", "Test School 2", x => x.Primary()));
    ...
    public async Task Absence_FilterBy_Type_WhenMissingEmptyOrInvalidValuesForSelectedSubject_ContainsNullValues()
    {
        ...
        series.Should().Equal(
            ...
            new MeasureSeries(MeasureSeriesType.ComparatorSchool, null, null, null),
    ...
    [Theory]
    public async Task Primary_Absence_FilterBy_PupilCharacteristic_ContainsCurrentYearValuesForSelectedCharacteristic(
    ...
    private static GetPrimaryComparisonAttendanceMeasuresRequest Request(
        string urn,
