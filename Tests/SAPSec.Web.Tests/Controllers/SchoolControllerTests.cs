...
public class SchoolControllerTests
{
    ...
    private static SchoolDetails CreateTestSchoolDetails(string urn, string name)
    {
        return new SchoolDetails
        {
            ...
            GovernanceStructure = DataWithAvailability.Available("Multi-academy trust (MAT)"),
            AcademyTrustName = DataWithAvailability.Available("Test Trust"),
            AcademyTrustId = DataWithAvailability.Available("5001"),
            NurseryProvision = DataWithAvailability.Available("Does not have a nursery provision"),
            SixthForm = DataWithAvailability.Available("Has a sixth form"),
            SenUnit = DataWithAvailability.Available("Has a SEN unit"),
            ResourcedProvision = DataWithAvailability.Available("Has a resourced provision"),
