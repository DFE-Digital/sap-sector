...
public class SchoolKs4CoreSubjectsPageIntegrationTests(
    ...
    ITestOutputHelper outputHelper) : InMemoryRepositoryIntegrationTests(fixture, outputHelper)
{
    ...
    public async Task Ks4CoreSubjects_WithNonExistentUrn_ReturnsNotFound()
    {
        ...
        var response = await Fixture.Client.GetAsync(Routes.SecondarySchool("999999").KS4CoreSubjects);
    ...
    public async Task EnglishLanguage_TableView_ShouldShowCorrectValues()
    {
        ...
        Fixture.Ks4PerformanceRepository.SetupLAPerformance(
            Build.Ks4Performance.LA("001", x => x.WithEngLang49(current: "91", prev: "90", prev2: "89")));
    ...
    public async Task EnglishLanguage_TableView_ValuesRoundTo0DecimalPlaces()
    {
        ...
        Fixture.Ks4PerformanceRepository.SetupLAPerformance(
            Build.Ks4Performance.LA("001", x => x.WithEngLang49(current: "91.02", prev: "89.7", prev2: "89.1")));
    ...
    [Fact]
    public async Task EnglishLanguage_TopPerformers_ShouldShowCorrectValues()
    {
        Fixture.EstablishmentRepository.SetupEstablishments(
    ...
    [Fact]
    public async Task EnglishLanguage_TopPerformers_ShouldLinkToSimilarSchoolsPage()
    {
        Fixture.EstablishmentRepository.SetupEstablishments(
            Build.Establishment("100001", "Test School 1", x => x.Secondary()),
            Build.Establishment("100002", "Test School 2", x => x.Secondary()),
    ...
    [InlineData("Grade 7 and above", new[] { "50%", "51%", "52%" }, new[] { "49%", "50%", "51%" }, new[] { "51%", "52%", "53%" }, new[] { "52%", "53%", "54%" })]
    [Theory]
    public async Task EnglishLanguage_GradeFilter_UpdatesTableViewWithSubjectValues(string filterOption, string[] currentSchool, string[] similarSchools, string[] la, string[] england)
    {
        Fixture.EstablishmentRepository.SetupEstablishments(
            Build.Establishment("100001", "Test School 1", x => x.Open().Secondary().InLA("001")),
            Build.Establishment("100002", "Test School 2", x => x.Open().Secondary().InLA("002")),
    ...
    public async Task EnglishLiterature_TableView_ValuesRoundTo0DecimalPlaces()
    {
        ...
        Fixture.Ks4PerformanceRepository.SetupEstablishmentPerformance(
            ...
            Build.Ks4Performance.Establishment("100002", x => x.WithEngLit49(current: "71.1", prev: "70.2", prev2: "69.3")));

        Fixture.Ks4PerformanceRepository.SetupEnglandPerformance(
            Build.Ks4Performance.England(x => x.WithEngLit49(current: "101.31", prev: "99.52", prev2: "99.49")));

        Fixture.Ks4PerformanceRepository.SetupLAPerformance(
            Build.Ks4Performance.LA("001", x => x.WithEngLit49(current: "91.02", prev: "89.7", prev2: "89.1")));
    ...
    [Fact]
    public async Task EnglishLiterature_TopPerformers_ShouldShowCorrectValues()
    {
        Fixture.EstablishmentRepository.SetupEstablishments(
            Build.Establishment("100001", "Test School 1", x => x.Secondary()),
            Build.Establishment("100002", "Test School 2", x => x.Secondary()),
        ...
        var table = page.ElementWithTestIdShouldExist<IHtmlTableElement>("eng-lit-top-performers-table");
    ...
    [Fact]
    public async Task EnglishLiterature_TopPerformers_ShouldLinkToSimilarSchoolsPage()
    {
        Fixture.EstablishmentRepository.SetupEstablishments(
            Build.Establishment("100001", "Test School 1", x => x.Secondary()),
            Build.Establishment("100002", "Test School 2", x => x.Secondary()),
        ...
        var similarSchoolsLink = page.ElementWithTestIdShouldExist("eng-lit-top-performers-similar-schools-link");
        similarSchoolsLink.GetAttribute("href").Should().Be(Routes.SecondarySchool("100001").ViewSimilarSchools);
    ...
    [InlineData("Grade 7 and above", new[] { "50%", "51%", "52%" }, new[] { "49%", "50%", "51%" }, new[] { "51%", "52%", "53%" }, new[] { "52%", "53%", "54%" })]
    [Theory]
    public async Task EnglishLiterature_GradeFilter_UpdatesTableViewWithSubjectValues(string filterOption, string[] currentSchool, string[] similarSchools, string[] la, string[] england)
    {
        Fixture.EstablishmentRepository.SetupEstablishments(
            Build.Establishment("100001", "Test School 1", x => x.Open().Secondary().InLA("001")),
            Build.Establishment("100002", "Test School 2", x => x.Open().Secondary().InLA("002")),
    ...
    public async Task Maths_TableView_ShouldShowCorrectValues()
    {
        ...
        Fixture.Ks4PerformanceRepository.SetupLAPerformance(
            Build.Ks4Performance.LA("001", x => x.WithMaths49(current: "91", prev: "90", prev2: "89")));
    ...
    public async Task Maths_TableView_ValuesRoundTo0DecimalPlaces()
    {
        ...
        Fixture.Ks4PerformanceRepository.SetupEstablishmentPerformance(
            ...
            Build.Ks4Performance.Establishment("100002", x => x.WithMaths49(current: "71.1", prev: "70.2", prev2: "69.3")));

        Fixture.Ks4PerformanceRepository.SetupEnglandPerformance(
            Build.Ks4Performance.England(x => x.WithMaths49(current: "101.31", prev: "99.52", prev2: "99.49")));

        Fixture.Ks4PerformanceRepository.SetupLAPerformance(
            Build.Ks4Performance.LA("001", x => x.WithMaths49(current: "91.02", prev: "89.7", prev2: "89.1")));
    ...
    [Fact]
    public async Task Maths_TopPerformers_ShouldShowCorrectValues()
    {
        Fixture.EstablishmentRepository.SetupEstablishments(
            Build.Establishment("100001", "Test School 1", x => x.Secondary()),
            Build.Establishment("100002", "Test School 2", x => x.Secondary()),
        ...
        var table = page.ElementWithTestIdShouldExist<IHtmlTableElement>("maths-top-performers-table");
    ...
    [Fact]
    public async Task Maths_TopPerformers_ShouldLinkToSimilarSchoolsPage()
    {
        Fixture.EstablishmentRepository.SetupEstablishments(
            Build.Establishment("100001", "Test School 1", x => x.Secondary()),
            Build.Establishment("100002", "Test School 2", x => x.Secondary()),
        ...
        var similarSchoolsLink = page.ElementWithTestIdShouldExist("maths-top-performers-similar-schools-link");
        similarSchoolsLink.GetAttribute("href").Should().Be(Routes.SecondarySchool("100001").ViewSimilarSchools);
    ...
    [InlineData("Grade 7 and above", new[] { "50%", "51%", "52%" }, new[] { "49%", "50%", "51%" }, new[] { "51%", "52%", "53%" }, new[] { "52%", "53%", "54%" })]
    [Theory]
    public async Task Maths_GradeFilter_UpdatesTableViewWithSubjectValues(string filterOption, string[] currentSchool, string[] similarSchools, string[] la, string[] england)
    {
        Fixture.EstablishmentRepository.SetupEstablishments(
            Build.Establishment("100001", "Test School 1", x => x.Open().Secondary().InLA("001")),
            Build.Establishment("100002", "Test School 2", x => x.Open().Secondary().InLA("002")),
    ...
    public async Task CombinedScience_TableView_ShouldShowCorrectValues()
    {
        ...
        Fixture.Ks4PerformanceRepository.SetupLAPerformance(
            Build.Ks4Performance.LA("001", x => x.WithCombSci49(current: "91", prev: "90", prev2: "89")));
    ...
    public async Task CombinedScience_TableView_ValuesRoundTo0DecimalPlaces()
    {
        ...
        Fixture.Ks4PerformanceRepository.SetupEstablishmentPerformance(
            ...
            Build.Ks4Performance.Establishment("100002", x => x.WithCombSci49(current: "71.1", prev: "70.2", prev2: "69.3")));

        Fixture.Ks4PerformanceRepository.SetupEnglandPerformance(
            Build.Ks4Performance.England(x => x.WithCombSci49(current: "101.31", prev: "99.52", prev2: "99.49")));

        Fixture.Ks4PerformanceRepository.SetupLAPerformance(
            Build.Ks4Performance.LA("001", x => x.WithCombSci49(current: "91.02", prev: "89.7", prev2: "89.1")));
    ...
    [Fact]
    public async Task CombinedScience_TopPerformers_ShouldShowCorrectValues()
    {
        Fixture.EstablishmentRepository.SetupEstablishments(
            Build.Establishment("100001", "Test School 1", x => x.Secondary()),
            Build.Establishment("100002", "Test School 2", x => x.Secondary()),
        ...
        var table = page.ElementWithTestIdShouldExist<IHtmlTableElement>("comb-sci-top-performers-table");
    ...
    [Fact]
    public async Task CombinedScience_TopPerformers_ShouldLinkToSimilarSchoolsPage()
    {
        Fixture.EstablishmentRepository.SetupEstablishments(
            Build.Establishment("100001", "Test School 1", x => x.Secondary()),
            Build.Establishment("100002", "Test School 2", x => x.Secondary()),
        ...
        var similarSchoolsLink = page.ElementWithTestIdShouldExist("comb-sci-top-performers-similar-schools-link");
        similarSchoolsLink.GetAttribute("href").Should().Be(Routes.SecondarySchool("100001").ViewSimilarSchools);
    ...
    [InlineData("Grade 4-4 and above", new[] { "70%", "71%", "72%" }, new[] { "69%", "70%", "71%" }, new[] { "71%", "72%", "73%" }, new[] { "72%", "73%", "74%" })]
    [InlineData("Grade 5-5 and above", new[] { "60%", "61%", "62%" }, new[] { "59%", "60%", "61%" }, new[] { "61%", "62%", "63%" }, new[] { "62%", "63%", "64%" })]
    [InlineData("Grade 7-7 and above", new[] { "50%", "51%", "52%" }, new[] { "49%", "50%", "51%" }, new[] { "51%", "52%", "53%" }, new[] { "52%", "53%", "54%" })]
    [Theory]
    public async Task CombinedScience_GradeFilter_UpdatesTableViewWithSubjectValues(string filterOption, string[] currentSchool, string[] similarSchools, string[] la, string[] england)
    {
        Fixture.EstablishmentRepository.SetupEstablishments(
            Build.Establishment("100001", "Test School 1", x => x.Open().Secondary().InLA("001")),
            Build.Establishment("100002", "Test School 2", x => x.Open().Secondary().InLA("002")),
    ...
    public async Task Biology_TableView_ShouldShowCorrectValues()
    {
        ...
        Fixture.Ks4PerformanceRepository.SetupLAPerformance(
            Build.Ks4Performance.LA("001", x => x.WithBio49(current: "91", prev: "90", prev2: "89")));
    ...
    public async Task Biology_TableView_ValuesRoundTo0DecimalPlaces()
    {
        ...
        Fixture.Ks4PerformanceRepository.SetupEstablishmentPerformance(
            ...
            Build.Ks4Performance.Establishment("100002", x => x.WithBio49(current: "71.1", prev: "70.2", prev2: "69.3")));

        Fixture.Ks4PerformanceRepository.SetupEnglandPerformance(
            Build.Ks4Performance.England(x => x.WithBio49(current: "101.31", prev: "99.52", prev2: "99.49")));

        Fixture.Ks4PerformanceRepository.SetupLAPerformance(
            Build.Ks4Performance.LA("001", x => x.WithBio49(current: "91.02", prev: "89.7", prev2: "89.1")));
    ...
    [Fact]
    public async Task Biology_TopPerformers_ShouldShowCorrectValues()
    {
        Fixture.EstablishmentRepository.SetupEstablishments(
            Build.Establishment("100001", "Test School 1", x => x.Secondary()),
            Build.Establishment("100002", "Test School 2", x => x.Secondary()),
        ...
        var table = page.ElementWithTestIdShouldExist<IHtmlTableElement>("bio-top-performers-table");
    ...
    [Fact]
    public async Task Biology_TopPerformers_ShouldLinkToSimilarSchoolsPage()
    {
        Fixture.EstablishmentRepository.SetupEstablishments(
            Build.Establishment("100001", "Test School 1", x => x.Secondary()),
            Build.Establishment("100002", "Test School 2", x => x.Secondary()),
        ...
        var similarSchoolsLink = page.ElementWithTestIdShouldExist("bio-top-performers-similar-schools-link");
        similarSchoolsLink.GetAttribute("href").Should().Be(Routes.SecondarySchool("100001").ViewSimilarSchools);
    ...
    [InlineData("Grade 7 and above", new[] { "50%", "51%", "52%" }, new[] { "49%", "50%", "51%" }, new[] { "51%", "52%", "53%" }, new[] { "52%", "53%", "54%" })]
    [Theory]
    public async Task Biology_GradeFilter_UpdatesTableViewWithSubjectValues(string filterOption, string[] currentSchool, string[] similarSchools, string[] la, string[] england)
    {
        Fixture.EstablishmentRepository.SetupEstablishments(
            Build.Establishment("100001", "Test School 1", x => x.Open().Secondary().InLA("001")),
            Build.Establishment("100002", "Test School 2", x => x.Open().Secondary().InLA("002")),
    ...
    public async Task Chemistry_TableView_ShouldShowCorrectValues()
    {
        ...
        Fixture.Ks4PerformanceRepository.SetupLAPerformance(
            Build.Ks4Performance.LA("001", x => x.WithChem49(current: "91", prev: "90", prev2: "89")));
    ...
    public async Task Chemistry_TableView_ValuesRoundTo0DecimalPlaces()
    {
        ...
        Fixture.Ks4PerformanceRepository.SetupEstablishmentPerformance(
            ...
            Build.Ks4Performance.Establishment("100002", x => x.WithChem49(current: "71.1", prev: "70.2", prev2: "69.3")));

        Fixture.Ks4PerformanceRepository.SetupEnglandPerformance(
            Build.Ks4Performance.England(x => x.WithChem49(current: "101.31", prev: "99.52", prev2: "99.49")));

        Fixture.Ks4PerformanceRepository.SetupLAPerformance(
            Build.Ks4Performance.LA("001", x => x.WithChem49(current: "91.02", prev: "89.7", prev2: "89.1")));
    ...
    [Fact]
    public async Task Chemistry_TopPerformers_ShouldShowCorrectValues()
    {
        Fixture.EstablishmentRepository.SetupEstablishments(
            Build.Establishment("100001", "Test School 1", x => x.Secondary()),
            Build.Establishment("100002", "Test School 2", x => x.Secondary()),
        ...
        var table = page.ElementWithTestIdShouldExist<IHtmlTableElement>("chem-top-performers-table");
    ...
    [Fact]
    public async Task Chemistry_TopPerformers_ShouldLinkToSimilarSchoolsPage()
    {
        Fixture.EstablishmentRepository.SetupEstablishments(
            Build.Establishment("100001", "Test School 1", x => x.Secondary()),
            Build.Establishment("100002", "Test School 2", x => x.Secondary()),
        ...
        var similarSchoolsLink = page.ElementWithTestIdShouldExist("chem-top-performers-similar-schools-link");
        similarSchoolsLink.GetAttribute("href").Should().Be(Routes.SecondarySchool("100001").ViewSimilarSchools);
    ...
    [InlineData("Grade 7 and above", new[] { "50%", "51%", "52%" }, new[] { "49%", "50%", "51%" }, new[] { "51%", "52%", "53%" }, new[] { "52%", "53%", "54%" })]
    [Theory]
    public async Task Chemistry_GradeFilter_UpdatesTableViewWithSubjectValues(string filterOption, string[] currentSchool, string[] similarSchools, string[] la, string[] england)
    {
        Fixture.EstablishmentRepository.SetupEstablishments(
            Build.Establishment("100001", "Test School 1", x => x.Open().Secondary().InLA("001")),
            Build.Establishment("100002", "Test School 2", x => x.Open().Secondary().InLA("002")),
    ...
    public async Task Physics_TableView_ShouldShowCorrectValues()
    {
        ...
        Fixture.Ks4PerformanceRepository.SetupLAPerformance(
            Build.Ks4Performance.LA("001", x => x.WithPhysics49(current: "91", prev: "90", prev2: "89")));
    ...
    public async Task Physics_TableView_ValuesRoundTo0DecimalPlaces()
    {
        ...
        Fixture.Ks4PerformanceRepository.SetupLAPerformance(
            Build.Ks4Performance.LA("001", x => x.WithPhysics49(current: "91.02", prev: "89.7", prev2: "89.1")));
    ...
    [Fact]
    public async Task Physics_TopPerformers_ShouldShowCorrectValues()
    {
        Fixture.EstablishmentRepository.SetupEstablishments(
            Build.Establishment("100001", "Test School 1", x => x.Secondary()),
            Build.Establishment("100002", "Test School 2", x => x.Secondary()),
        ...
        var table = page.ElementWithTestIdShouldExist<IHtmlTableElement>("phys-top-performers-table");
    ...
    [Fact]
    public async Task Physics_TopPerformers_ShouldLinkToSimilarSchoolsPage()
    {
        Fixture.EstablishmentRepository.SetupEstablishments(
            Build.Establishment("100001", "Test School 1", x => x.Secondary()),
            Build.Establishment("100002", "Test School 2", x => x.Secondary()),
        ...
        var similarSchoolsLink = page.ElementWithTestIdShouldExist("phys-top-performers-similar-schools-link");
        similarSchoolsLink.GetAttribute("href").Should().Be(Routes.SecondarySchool("100001").ViewSimilarSchools);
    ...
    [InlineData("Grade 7 and above", new[] { "50%", "51%", "52%" }, new[] { "49%", "50%", "51%" }, new[] { "51%", "52%", "53%" }, new[] { "52%", "53%", "54%" })]
    [Theory]
    public async Task Physics_GradeFilter_UpdatesTableViewWithSubjectValues(string filterOption, string[] currentSchool, string[] similarSchools, string[] la, string[] england)
    {
        Fixture.EstablishmentRepository.SetupEstablishments(
            Build.Establishment("100001", "Test School 1", x => x.Open().Secondary().InLA("001")),
            Build.Establishment("100002", "Test School 2", x => x.Open().Secondary().InLA("002")),
