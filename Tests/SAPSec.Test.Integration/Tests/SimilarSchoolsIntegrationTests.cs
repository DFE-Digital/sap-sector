...
public class SimilarSchoolsIntegrationTests(JsonRepositoryIntegrationTestFixture fixture)
{
    ...
    {
        var response = await fixture.Client.GetAsync("/school/secondary/999999/view-similar-schools");
    ...
    {
        var response = await fixture.Client.GetAsync("/school/secondary/105574/view-similar-schools");
    ...
    {
        var response = await fixture.Client.GetAsync("/school/secondary/105574/view-similar-schools?ur=doesnotexist");
        var content = await response.Content.ReadAsStringAsync();
    ...
    {
        var response = await fixture.NonRedirectingClient.GetAsync("/school/secondary/105574/similar-schools");
        ...
        response.Headers.Location!.ToString().Should().Contain("/school/secondary/105574/view-similar-schools");
    }

    [Fact]
    public async Task ComparisonKs4HeadlineMeasures_ReturnsComparisonContent()
    {
        var response = await fixture.Client.GetAsync("/school/secondary/108088/view-similar-schools/137621/Ks4HeadlineMeasures");
        var content = await response.Content.ReadAsStringAsync();
