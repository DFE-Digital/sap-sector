    ...
    ITestOutputHelper outputHelper) : InMemoryRepositoryIntegrationTests(fixture, outputHelper)
{
    ...
    public async Task Attendance_TableView_ShouldShowCorrectValues()
    {
        ...
        Fixture.AbsenceRepository.SetupEnglandAbsence(
            Build.Absence.England(x => x.WithOverallAbsencePrimary(current: "10.10", previous: "10.00", previous2: "9.90")));

        Fixture.AbsenceRepository.SetupLAAbsence(
            Build.Absence.LA("001", x => x.WithOverallAbsencePrimary(current: "9.10", previous: "9.00", previous2: "8.90")));
    ...
    public async Task Attendance_TableView_ValuesRoundTo2DecimalPlaces()
    {
        ...
        Fixture.AbsenceRepository.SetupEnglandAbsence(
            Build.Absence.England(x => x.WithOverallAbsencePrimary(current: "7.205", previous: "8.524", previous2: "9.495")));

        Fixture.AbsenceRepository.SetupLAAbsence(
            Build.Absence.LA("001", x => x.WithOverallAbsencePrimary(current: "9.102", previous: "8.975", previous2: "8.914")));
    ...
    public async Task Attendance_TypeFilter_UpdatesTableViewWithTypeValues(string filterOption, string[] currentSchool, string[] la, string[] england)
    {
        ...
        Fixture.AbsenceRepository.SetupLAAbsence(
             Build.Absence.LA("001", x => x
                .WithOverallAbsencePrimary(current: "7.30", previous: "7.20", previous2: "7.10")
                .WithPersistentAbsencePrimary(current: "5.90", previous: "6.00", previous2: "6.10")));

        Fixture.AbsenceRepository.SetupEnglandAbsence(
            Build.Absence.England(x => x
                .WithOverallAbsencePrimary(current: "7.10", previous: "7.20", previous2: "7.30")
                .WithPersistentAbsencePrimary(current: "6.10", previous: "6.20", previous2: "6.30")));
