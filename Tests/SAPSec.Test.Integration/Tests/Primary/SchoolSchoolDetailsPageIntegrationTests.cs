    ...
    ITestOutputHelper outputHelper) : InMemoryRepositoryIntegrationTests(fixture, outputHelper)
{
    ...
    public async Task NonExistentUrn_ReturnsNotFound()
    {
        ...
        await Fixture.RequestPageAsync(Routes.PrimarySchool("999999").SchoolDetails, HttpStatusCode.NotFound);
    }
    ...
    public async Task CaptionAndHeading_DisplaysSchoolName()
    {
        ...
        var page = await Fixture.RequestPageAsync(Routes.PrimarySchool("100001").SchoolDetails, HttpStatusCode.OK);
    ...
    public async Task FurtherInformationSection_ContainsCorrectLinks()
    {
        ...
        page.TermShouldExistWithDefinition("Ofsted report", el => el.ChildElementShouldExist("a")
            .ShouldLinkTo("View the latest Ofsted report (opens in new tab)", "https://reports.ofsted.gov.uk/provider/21/100001"));
