...
public class LADestinationsBuilder(string laId)
{
    ...
    public LADestinations Build() =>
        new()
        {
            ...
            Apprentice_Tot_LA_Current_Pct = Apprentice_Tot_LA_Current_Pct,
            Apprentice_Tot_LA_Previous_Pct = Apprentice_Tot_LA_Previous_Pct,
            Apprentice_Tot_LA_Previous2_Pct = Apprentice_Tot_LA_Previous2_Pct,
